...
export default function UpgradeCenterModal({ state, setState, buyUpgrade, repairUpgrade, onClose }: UpgradeCenterModalProps) {
  const basePrice = 16;
    ...
    >
      <div className="w-full max-w-2xl pixel-border bg-black p-6 flex flex-col max-h-[80vh]">
        ...
        <div className="flex-1 overflow-y-auto space-y-6 pr-2">
          ...
          {(state.power <= 0 || state.defense <= 0 || state.damagedUpgrades.weapons || state.damagedUpgrades.shields) && (
            <div className="p-3 border border-yellow-500/30 bg-yellow-500/5">
              ...
              <div className="text-[10px] opacity-70 italic space-y-1">
                ...
                {state.damagedUpgrades.shields && state.defense > 0 && <p className="text-yellow-400">Shields compromised: Defense limited.</p>}
              </div>
            </div>
          )}
